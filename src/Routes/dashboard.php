...
//    ]);
    ...
    Route::post('/setpermission2', [
        'name' => 'ACL Manager Set permission 2',
        'as' => 'extensionsvalley.admin.setpermission2',
        'uses' => 'ExtensionsValley\Dashboard\ACLController@setPermission',
    ]);
});
