            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        ...
                        <a href="{{route('extensionsvalley.admin.addnewpackage')}}"
                           class="btn btn-primary pull-right"><i class="fa fa-plus"></i> Install or Update Package</a>
                        <a class="btn btn-round btn-dark pull-right"
                           href="{{route('extensionsvalley.admin.manageextension',['status' => 1])}}">Active
                            : {{$full_extensions->where('status',1)->count()}}</a>
                        <a class="btn btn-round btn-dark pull-right"
                           href="{{route('extensionsvalley.admin.manageextension',['status' => 0])}}">Disabled
                            : {{$full_extensions->where('status',0)->count()}}</a>
                        <a class="btn btn-round btn-dark pull-right"
                                                ...
                                                <div class="col-sm-12">
                                                    ...
                                                    <div class="left col-xs-8">
                                                        ...
                                                        <ul class="list-unstyled">
                                                            ...
                                                            <li>
                                                                Installed: {{date('Y-m-d',strtotime($items->created_at))}}
                                                    ...
                                                    <div class="right col-xs-4 text-center">
                                                        @if(file_exists(base_path()."/public/".$items->icon))
                                                            <img src="{{URL::to('/')}}/{{$items->icon}}" alt=""
                                                                 class="img-circle img-responsive">
                                                        @else
                                                            <img src="{{URL::to('/')}}/packages/extensionsvalley/dashboard/images/laflux-logo.png"
                                                ...
                                                <div class="col-xs-12 bottom">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        ...
                                                        && ($items->name == "Dashboard"))
                                                            <a href="{{$items->website}}" target="_blank"
                                                               class="btn btn-dark btn-xs pull-right">Website</a>
                                                        @else
