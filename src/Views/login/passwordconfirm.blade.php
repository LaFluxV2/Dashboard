            ...
            <section class="login_content">
                ...
                <div class="login-panel panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        {!! Form::token() !!}
                        {!! Form::close() !!}
                        <div class="pull-left" style="padding-top:10px;"><a
                                    href="{{route('extensionsvalley.admin.reset')}}">Send
                                New Request ?</a></div>
                        <div class="pull-right" style="padding-top:10px;"><a
                                    href="{{route('extensionsvalley.admin.login')}}">Back
                                to login ?</a></div>
                    </div>
                </div>
