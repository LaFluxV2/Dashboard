...
@section('content-area')
    <div class="right_col" role="main">
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-xs-12">
                @if(!empty($table->show_toolbar) || !empty($table->custom_toolbar))
    ...
    <script>
        jQuery(document).ready(function () {
            ...
            var handleDataTableButtons = function () {
                jQuery('#datatable-buttons').DataTable({
                    ...
                    "processing": true,
                    "ajax": {
                        url: "{{route('extensionsvalley.admin.ajax.list',['namespace' => base64_encode($table->namespace)])}}",
                        data: function (d) {
        ...
        $acl_permission = \DB::table('acl_permission')
            ...
            ->first();
        ?>
        @if(!empty($table->show_toolbar['edit']) && $acl_permission->edit == 1) // Take from toolbar section code
        // Onclick Edit
        $(document).ready(function () {
            ...
            $('#datatable-buttons tbody').on('click', 'tr', function () {
                ...
                var action_url = main_uri + route_path + id;
