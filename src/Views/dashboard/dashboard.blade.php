...
<!-- Air Date Picker -->
<link href="{{asset("packages/extensionsvalley/dashboard/packages/airdatepicker/datepicker.min.css")}}" rel="stylesheet">
<script src="{{asset("packages/extensionsvalley/dashboard/packages/airdatepicker/datepicker.min.js")}}"></script>
<script src="{{asset("packages/extensionsvalley/dashboard/packages/airdatepicker/datepicker.en.js")}}"></script>

<!-- Ripple effect JS -->
<link href="{{asset("packages/extensionsvalley/dashboard/packages/ripple_effect/ripple.min.css")}}" rel="stylesheet">
<script src="{{asset("packages/extensionsvalley/dashboard/packages/ripple_effect/ripple.min.js")}}"></script>
<!-- Usage : <a class="material-ripple" data-ripple-color="#CB8962" href="#"> -->

<!-- Toastr -->
<link href="{{asset("packages/extensionsvalley/dashboard/packages/toastr/build/toastr.min.css")}}" rel="stylesheet">
<script src="{{asset("packages/extensionsvalley/dashboard/packages/toastr/build/toastr.min.js")}}"></script>


<script type="text/javascript">
    jQuery(document).ready(function () {
        <!-- Toastr Initilization -->
        toastr.options = {
            "closeButton": true,
            "debug": false,
            "newestOnTop": true,
...
{{-- For Disappearing messages notifications --}}
<script>
    jQuery(document).ready(function () {
