...
class LoginController extends Controller
{
    ...
    public function getAutendicate(Request $request)
    {
        ...
        // Maitenance Mode Checking
        $maitenance_mode = \DB::table('system_settings')->Where('key', 'maintenance_mode')
            ->value('value');
        ...
        if ($maitenance_mode == 1) {
            if ($user_role_type != 'SU' && $user_role_type != 'A') {
                return \View::make('Dashboard::dashboard.maintenancemode');
            }
        }
